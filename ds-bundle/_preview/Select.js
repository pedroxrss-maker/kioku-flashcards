...
var __dsPreview = (() => {
  ...
  var Stage = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { background: "var(--bg)", padding: 24, maxWidth: 320 }, children });
  function Default() {
    const [v, setV] = (0, import_react.useState)("en-US");
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stage, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.Select,
      {
        value: v,
        onChange: setV,
        ariaLabel: "Idioma de voz",
        options: [
