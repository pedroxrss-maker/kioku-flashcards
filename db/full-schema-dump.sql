...
\restrict NyR57mSkNadY1sNnaxEofdggUedfeq1OQdi93uzk7UkMqU7fTxu9fG0qXTGSmrS
...
--
-- Name: idx_cards_deck; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX idx_cards_due ON public.cards USING btree (user_id, due);


--
-- Name: idx_decks_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_logs_user_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_logs_user_time ON public.review_logs USING btree (user_id, reviewed_at);
...
--
-- Name: review_logs review_logs_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: review_logs review_logs_deck_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.review_logs
    ADD CONSTRAINT review_logs_deck_id_fkey FOREIGN KEY (deck_id) REFERENCES public.decks(id) ON DELETE CASCADE;
...
--
-- Name: cards cartas próprias; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "cartas próprias" ON public.cards USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: decks decks próprios; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "decks próprios" ON public.decks USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: review_logs logs próprios; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "logs próprios" ON public.review_logs USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: profiles perfil próprio; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "perfil próprio" ON public.profiles USING ((auth.uid() = id)) WITH CHECK ((auth.uid() = id));
...
--
-- Name: objects kioku media delete own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "kioku media delete own" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'media'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects kioku media insert own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "kioku media insert own" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'media'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects kioku media read own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "kioku media read own" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'media'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects kioku media update own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "kioku media update own" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'media'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text))) WITH CHECK (((bucket_id = 'media'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));
...
\unrestrict NyR57mSkNadY1sNnaxEofdggUedfeq1OQdi93uzk7UkMqU7fTxu9fG0qXTGSmrS
